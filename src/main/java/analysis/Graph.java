...
public class Graph {
	...
	protected int nodeCount =0; // counter for number of nodes
	protected int edgeCount =0; // counter for number of edges
	...
	public void addEdge(Node a, Node b) {
		graph.addEdge(a,b);
		edgeCount++; // increment edge counter
		
	}
	
	public int getEdgeCount()//returns the edge count value
	{
		return edgeCount;
	}
	
	public int getNodeCount()//returns the node count value
	{
		return nodeCount;
	}
